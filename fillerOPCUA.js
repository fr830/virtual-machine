...
var address_space_for_conformance_testing = require("./node_modules/node-opcua/lib/simulation/address_space_for_conformance_testing");
var build_address_space_for_conformance_testing = address_space_for_conformance_testing.build_address_space_for_conformance_testing;

var install_optional_cpu_and_memory_usage_node = require("./node_modules/node-opcua/lib/server/vendor_diagnostic_nodes").install_optional_cpu_and_memory_usage_node;
...
server.on("post_initialize", function () {
  ...
  addressSpace.addVariable({
    organizedBy: myDevices,
    browseName: "Setter",
    nodeId: "ns=1;s=Setter",
    dataType: "String",
    value: {
      get: function () {
        return new Variant({dataType: 'String', value: setter});
      },
  ...
  var temp = addressSpace.addVariable({
    organizedBy: myDevices,
